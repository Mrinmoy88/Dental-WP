...
<html class="no-js" lang="en">
  <head>
    ...
    />
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="images/demo_logo.svg" />
    <!-- CSS
			============================================ -->
    <!-- Bootstrap CSS -->
                      ...
                      <ul class="navigation clearfix">
                        ...
                        <li class="dropdown">
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="service-details.html">Prosthesis</a>
                            </li>
                            <li>
                              <a href="service-details.html"
                            ...
                            <li>
                              <a href="service-details.html"
                                >Simple and Surgical Extraction</a
                              >
                            </li>
                            <li><a href="service-details.html">Implant</a></li>
                          </ul>
                        </li>
              ...
              <div class="pbmit-button-box-second">
                <a class="pbmit-btn" href="make-appointments-01.html">
                  <span class="pbmit-button-content-wrapper">
                    ...
                    <span class="pbmit-button-text">Book An Appointment</span>
                  </span>
                </a>
              </div>
            </div>
      ...
      <div class="page-content">
						...
						<div class="row text-center">
						  <div class="col-md-12">
							<div class="pbmit-slider-content">
							  ...
							  <h2
								class="pbmit-title transform-bottom transform-delay-2"
							  >
								Best Healthcare <br />
								<strong>Experience</strong>
							  </h2>
							  <div
								class="pbmit-button transform-bottom transform-delay-3"
							  >
								<a
				  ...
				  <div class="swiper-slide">
					<div class="pbmit-slider-item">
					  <div
						class="pbmit-slider-bg"
						style="
						  background-image: url(images/slider-img/demo01-slide-02.jpg);
						"
					  ></div>
					  <div class="container">
						<div class="row text-center">
              ...
              <div class="col-md-6 col-lg-4 position-relative">
                <div class="pbmit-widget_icon">
                  <div class="pbmit_icon">
                    <i
                      class="pbmit-xcare-icon pbmit-xcare-icon-appointment"
                    ></i>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-lg-4 position-relative">
                ...
                <div class="inner-box_style inner-box_2">
                  ...
                  <div class="pbmit-text_aditor">
                    ...
                    answers and assurance you deserve with accuracy you can
                    trust.
                  </div>
                      ...
                      <div class="pbmit-ihbox-icon">
                        <div class="pbmit-ihbox-icon-wrapper">
                          <div class="pbmit-icon-wrapper pbmit-icon-type-icon">
                            <i
                              class="pbmit-xcare-icon pbmit-xcare-icon-live-chat"
                            ></i>
                          </div>
                        </div>
                      </div>
                      <div class="pbmit-ihbox-contents">
                        <h4 class="pbmit-element-heading">Emergency Cases</h4>
                        <h2 class="pbmit-element-title">+9876543210</h2>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-5 about-us-two_col1">
                  <div class="about-us-two_img">
                    <img
                      src="images/homepage-2/about-img-02.jpg"
                      class="img-fluid"
                      alt=""
                    />
                  </div>
                ...
                <div
                  class="col-md-7 about-us-two_col2 pbmit-sticky-col2-special"
                >
                  <div class="about-us-two_rightbox">
                    ...
                    <div class="about-us-two_innerbox">
                      <div>
                        Despite a robust ecosystem of its own, does not exist in
                        isolation. It integrates with other services and systems
                        intended to enhance the community’s health and emergency
                        ...
                        <div class="pbmit-ihbox-box d-flex align-items-center">
                          <div class="pbmit-ihbox-icon">
                            <div class="pbmit-ihbox-icon-wrapper">
                              ...
                              >
                                <i
                                  class="pbmit-xcare-icon pbmit-xcare-icon-medicine-1"
                                ></i>
                              </div>
                            </div>
                          </div>
                          <div class="pbmit-ihbox-contents">
                            ...
                            <div class="pbmit-heading-desc">
                              This site includes an overview of how infections
                              spread, ways to prevent the spread of infections
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="pbmit-ihbox-box d-flex align-items-center">
                          <div class="pbmit-ihbox-icon">
                            <div class="pbmit-ihbox-icon-wrapper">
                              ...
                              >
                                <i
                                  class="pbmit-xcare-icon pbmit-xcare-icon-avatar"
                                ></i>
                              </div>
                            </div>
                          </div>
                          <div class="pbmit-ihbox-contents">
                            ...
                            <div class="pbmit-heading-desc">
                              Another part of preventive health is learning to
                              recognize changes in your body that may not be
                              normal
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="img_box">
                        <img
                          src="images/homepage-2/about-img-03.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                      ...
                      <div>
                        Digital Opration is a technique used for thousands of
                        years to develop awareness of the present moment, It can
                        involve practices to sharpen focus and attention
                      </div>
                            ...
                            <ul class="list-group list-group-borderless">
                              <li class="list-group-item">
                                ...
                                <span class="pbmit-icon-list-text"
                                  >Avoid ultra-processed foods</span
                                >
                              </li>
                              <li class="list-group-item">
                                <span class="pbmit-icon-list-icon">
                              ...
                              <li class="list-group-item">
                                ...
                                <span class="pbmit-icon-list-text"
                                  >Minimize your sugar intake</span
                                >
                              </li>
                            </ul>
                          </div>
                          <div class="col-md-6">
                            <ul class="list-group list-group-borderless">
                              <li class="list-group-item">
                                ...
                                <span class="pbmit-icon-list-text"
                                  >Avoid bright lights before sleep</span
                                >
                              </li>
                              <li class="list-group-item">
                                <span class="pbmit-icon-list-icon">
                              ...
                              <li class="list-group-item">
                                ...
                                <span class="pbmit-icon-list-text"
                                  >Avoid harmful use of alcohol</span
                                >
                              </li>
                            </ul>
                          </div>
              ...
              <div class="col-md-12 col-lg-5 pbmit-sticky-col">
                <div class="pbmit-ele-header-area">
                  <div class="pbmit-heading-subheading">
                    ...
                    <div class="pbmit-heading-desc">
                      The healthcare arena there was a felt need of developing
                      new as well as upgrading the existing functioning and
                      processes, consequently develop an institution supported
                      with necessary
                    </div>
                  </div>
                        ...
                        <div class="pbmit-box-content-inner">
                          <div class="pbmit-content-inner-wrap">
                            ...
                            <div class="pbmit-service-icon">
                              <i
                                class="pbmit-xcare-icon pbmit-xcare-icon-gesundheit-1"
                              ></i>
                            </div>
                          </div>
                          <div class="pbmit-service-description">
                            The medical professional doctors available in the
                            clinic
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="pbmit-box-content-wrap">
                        ...
                        <div class="pbmit-box-content-inner">
                          <div class="pbmit-content-inner-wrap">
                            ...
                            <div class="pbmit-service-icon">
                              <i
                                class="pbmit-xcare-icon pbmit-xcare-icon-pills"
                              ></i>
                            </div>
                          </div>
                          <div class="pbmit-service-description">
                      ...
                      <div class="pbmit-box-content-wrap">
                        ...
                        <div class="pbmit-box-content-inner">
                          <div class="pbmit-content-inner-wrap">
                            ...
                            <div class="pbmit-service-icon">
                              <i
                                class="pbmit-xcare-icon pbmit-xcare-icon-joint"
                              ></i>
                            </div>
                          </div>
                          <div class="pbmit-service-description">
                      ...
                      <div class="pbmit-box-content-wrap">
                        ...
                        <div class="pbmit-box-content-inner">
                          <div class="pbmit-content-inner-wrap">
                            ...
                            <div class="pbmit-service-icon">
                              <i
                                class="pbmit-xcare-icon pbmit-xcare-icon-ppe"
                              ></i>
                            </div>
                          </div>
                          <div class="pbmit-service-description">
                      ...
                      <div class="pbmit-box-content-wrap">
                        ...
                        <div class="pbmit-box-content-inner">
                          <div class="pbmit-content-inner-wrap">
                            ...
                            <div class="pbmit-service-icon">
                              <i
                                class="pbmit-xcare-icon pbmit-xcare-icon-chemistry-1"
                              ></i>
                            </div>
                          </div>
                          <div class="pbmit-service-description">
        ...
        <section class="section-lgt portfolio_two">
          <div class="container-fluid p-0">
            <div
              class="swiper-slider portfolio-two_slider"
              data-autoplay="false"
              data-loop="true"
              data-dots="false"
              data-arrows="false"
                      ...
                      <div class="pbminfotech-box-content">
                        <div class="pbminfotech-titlebox">
                          ...
                          <h3 class="pbmit-portfolio-title">
                            <a href="single-detail-style-01.html"
                              >Neurosurgery Surgeon</a
                            >
                          </h3>
                        </div>
                      </div>
                  ...
                  <article class="pbmit-portfolio-style-2">
                    <div class="pbminfotech-post-content">
                      <div class="pbmit-featured-img-wrapper">
                        <div class="pbmit-featured-wrapper">
                          <img
                            src="images/homepage-2/portfolio/portfolio-05.jpg"
                            class="img-fluid"
                            alt=""
                          />
                        </div>
                  ...
                  <article class="pbmit-portfolio-style-2">
                    <div class="pbminfotech-post-content">
                      <div class="pbmit-featured-img-wrapper">
                        <div class="pbmit-featured-wrapper">
                          <img
                            src="images/homepage-2/portfolio/portfolio-06.jpg"
                            class="img-fluid"
                            alt=""
                          />
                        </div>
                  ...
                  <article class="pbmit-portfolio-style-2">
                    <div class="pbminfotech-post-content">
                      <div class="pbmit-featured-img-wrapper">
                        <div class="pbmit-featured-wrapper">
                          <img
                            src="images/homepage-2/portfolio/portfolio-07.jpg"
                            class="img-fluid"
                            alt=""
                          />
                        </div>
                  ...
                  <article class="pbmit-portfolio-style-2">
                    <div class="pbminfotech-post-content">
                      <div class="pbmit-featured-img-wrapper">
                        <div class="pbmit-featured-wrapper">
                          <img
                            src="images/homepage-2/portfolio/portfolio-08.jpg"
                            class="img-fluid"
                            alt=""
                          />
                        </div>
                  ...
                  <article class="pbmit-portfolio-style-2">
                    <div class="pbminfotech-post-content">
                      <div class="pbmit-featured-img-wrapper">
                        <div class="pbmit-featured-wrapper">
                          <img
                            src="images/homepage-2/portfolio/portfolio-09.jpg"
                            class="img-fluid"
                            alt=""
                          />
                        </div>
        ...
        <section class="section-xl">
          <div class="container">
            <div class="position-relative">
              ...
              <div
                class="testimonial_arrow swiper-btn-custom d-flex flex-row-reverse"
              ></div>
            </div>
            <div
              class="swiper-slider"
                  ...
                  <article class="pbmit-testimonial-style-1">
                    <div class="pbminfotech-post-item">
                      <div class="pbmit-box-content-wrap">
                        ...
                        <div
                          class="pbminfotech-box-author d-flex align-items-center"
                        >
          ...
          <div class="container">
            ...
            <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                      <article class="pbmit-blog-style-4">
                        <div class="post-item">
                          <div class="pbminfotech-box-content">
                            <div
                              class="pbminfotech-content-inner d-flex align-items-center"
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                                  <img
                                ...
                                <div class="pbmit-content-wrapper">
                                  <h3 class="pbmit-post-title">
                                    <a href="blog-details.html"
                                      >What’s the reason so many older adults
                                      aren’t active?</a
                                    >
                                  </h3>
                                </div>
                            ...
                            >
                              ...
                              <div class="pbmit-meta-wraper">
                                ...
                                <div class="pbmit-content-wrapper">
                                  <h3 class="pbmit-post-title">
                                    <a href="blog-details.html"
                                      >The Most important Ventilator Equipment
                                      available</a
                                    >
                                  </h3>
                                </div>
                            ...
                            >
                              ...
                              <div class="pbmit-meta-wraper">
                                ...
                                <div class="pbmit-content-wrapper">
                                  <h3 class="pbmit-post-title">
                                    <a href="blog-details.html"
                                      >Blood Cancers: Early Signs, Symptoms,
                                      Institute</a
                                    >
                                  </h3>
                                </div>
              ...
              <div class="col-md-12 col-xl-7">
                <div
                  class="swiper-slider blog-two_slider"
                  data-autoplay="false"
                  data-loop="true"
                  data-dots="false"
                  data-arrows="false"
                        ...
                        <div class="post-item d-flex">
                          <div class="pbmit-featured-container">
                            <div
                              ...
                              style="
                                background-image: url('images/homepage-2/blog/blog-04b.jpg');
                              "
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                          ...
                          <div class="pbminfotech-box-wrap">
                            <div class="pbminfotech-box-content">
                              ...
                              <h3 class="pbmit-post-title">
                                <a href="blog-details.html"
                                  >Best &amp; caring Orthopedic surgeons in
                                  hospital</a
                                >
                              </h3>
                              <div class="pbminfotech-box-desc">
                                Medical Futurist is one of the best online
                                resources for learning about technology in the…
                              </div>
                            </div>
                        ...
                        <div class="post-item d-flex">
                          <div class="pbmit-featured-container">
                            <div
                              class="pbmit-bg-image"
                              style="
                                background-image: url('images/homepage-2/blog/blog-05b.jpg');
                              "
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                                  <img
                                    src="images/homepage-2/blog/blog-05.jpg"
                                    class="img-fluid"
                                    alt=""
                                  />
                                </div>
                          ...
                          <div class="pbminfotech-box-wrap">
                            <div class="pbminfotech-box-content">
                              ...
                              <h3 class="pbmit-post-title">
                                <a href="blog-details.html"
                                  >Cell perturbation and lasers illuminate the
                                  genetics</a
                                >
                              </h3>
                              <div class="pbminfotech-box-desc">
                        ...
                        <div class="post-item d-flex">
                          <div class="pbmit-featured-container">
                            <div
                              class="pbmit-bg-image"
                              style="
                                background-image: url('images/homepage-2/blog/blog-06b.jpg');
                              "
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                                  <img
                                    src="images/homepage-2/blog/blog-06.jpg"
                                    class="img-fluid"
                                    alt=""
                                  />
                                </div>
                          ...
                          <div class="pbminfotech-box-wrap">
                            <div class="pbminfotech-box-content">
                              ...
                              <h3 class="pbmit-post-title">
                                <a href="blog-details.html"
                                  >Do’s and Don’ts or precautions after cataract
                                  surgery</a
                                >
                              </h3>
                              <div class="pbminfotech-box-desc">
                        ...
                        <div class="post-item d-flex">
                          <div class="pbmit-featured-container">
                            <div
                              class="pbmit-bg-image"
                              style="
                                background-image: url('images/homepage-2/blog/blog-07b.jpg');
                              "
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                                  <img
                                    src="images/homepage-2/blog/blog-07.jpg"
                                    class="img-fluid"
                                    alt=""
                                  />
                                </div>
                          ...
                          <div class="pbminfotech-box-wrap">
                            <div class="pbminfotech-box-content">
                              ...
                              <h3 class="pbmit-post-title">
                                <a href="blog-details.html"
                                  >Dental or Implant. What is the Best
                                  Option?</a
                                >
                              </h3>
                              <div class="pbminfotech-box-desc">
                        ...
                        <div class="post-item d-flex">
                          <div class="pbmit-featured-container">
                            <div
                              class="pbmit-bg-image"
                              style="
                                background-image: url('images/homepage-2/blog/blog-08b.jpg');
                              "
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                                  <img
                                    src="images/homepage-2/blog/blog-08.jpg"
                                    class="img-fluid"
                                    alt=""
                                  />
                                </div>
                          ...
                          <div class="pbminfotech-box-wrap">
                            <div class="pbminfotech-box-content">
                              ...
                              <h3 class="pbmit-post-title">
                                <a href="blog-details.html"
                                  >Must Read Safety Guide For Swine Flu
                                  Season</a
                                >
                              </h3>
                              <div class="pbminfotech-box-desc">
                        ...
                        <div class="post-item d-flex">
                          <div class="pbmit-featured-container">
                            <div
                              class="pbmit-bg-image"
                              style="
                                background-image: url('images/homepage-2/blog/blog-09b.jpg');
                              "
                            >
                              <div class="pbmit-featured-img-wrapper">
                                <div class="pbmit-featured-wrapper">
                                  <img
                                    src="images/homepage-2/blog/blog-09.jpg"
                                    class="img-fluid"
                                    alt=""
                                  />
                                </div>
                          ...
                          <div class="pbminfotech-box-wrap">
                            <div class="pbminfotech-box-content">
                              ...
                              <h3 class="pbmit-post-title">
                                <a href="blog-details.html"
                                  >Having Viral Pneumonia with Severe ARDS,
                                  CKD</a
                                >
                              </h3>
                              <div class="pbminfotech-box-desc">
                ...
                <aside class="widget widget_text">
                  <div class="textwidget">
                    <div class="pbmit-footer-logo">
                      <img src="images/demo_logo.png" alt="" />
                    </div>
                    <div class="pbmit-footer-text">
                      The healthcare arena there was a felt need of developing
                      new as well as upgrading the existing functioning.
                    </div>
