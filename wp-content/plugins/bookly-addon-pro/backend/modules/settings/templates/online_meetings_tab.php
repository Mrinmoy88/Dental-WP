        ...
        <div class="card-body">
            <div class="card bookly-collapse-with-arrow">
                ...
                <div id="bookly_om_zoom" class="bookly-collapse bookly-show">
                    <div class="card-body">
                        <p><?php printf( __( 'To set up Zoom integration, follow the instructions in <a href="%s" target="_blank">our documentation</a>', 'bookly' ), 'https://api.booking-wp-plugin.com/go/bookly-settings-online-meetings' ) ?></p>
